...
connectionString = r'eris_gis/gis295@cabcvan1ora003.glaciermedia.inc:1521/GMPRODC' #r'ERIS_GIS/gis295@GMPRODC.glaciermedia.inc'
...
def getGrids():
    ...
    while True:
        try:
            grid = raw_input("Enter Grid Code: ")
        ...
        # if len(aerial) == 0: #KeyboardInterrupt:
        #     break    
    return aerials
        ...
        try:
            ...
            for i, line in enumerate(fp):
                if i == 2:
                    ...
                    print ("Year: " + str(year) + " & Scale: " + str(scale))
                    break
            fp.close()
