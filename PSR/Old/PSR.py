...
###############################################################################################################
    ...
    connectionString = PSR_config.connectionString
    report_path = PSR_config.report_path
    viewer_path = PSR_config.viewer_path
    upload_link = PSR_config.upload_link
    reportcheck_path = PSR_config.reportcheck_path
###############################################################################################################
